;(function(ns, $) {
	...
	RossiApp.prototype = {
		...
		_createControls: function() {
			...
			//popups.zamerschik = new ns.PopupZamerschik(this._state);
			//popups.installment = new ns.PopupInstallment(this._state);
		},
		...
		_attachEvents: function() {
			...
			// BUTTONS CLICK EVENTS
				...
				.on('clicked:button-callback', function(clickEvent) {
					alert('clicked:button-callback');
				})
				.on('clicked:button-zamerschik', function(clickEvent) {
					alert('clicked:button-zamerschik');
				})
