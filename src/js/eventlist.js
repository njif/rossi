...
/*		// events for AppState						// events for controls
		'buttons.callback.clicked': 				'clicked:button-callback',
		'button.zamerschik.clicked': 				'clicked:button-zamerschik',
		'button.installment.clicked': 				'clicked:button-installment',

	// PAGE MENU CLICK EVENTS

		'mainmenu.services.clicked`': 				'clicked:page-installment',
		'mainmenu.products.clicked': 				'clicked:page-installment',
		'mainmenu.career.clicked': 					'clicked:page-career',
		'mainmenu.contacts.clicked': 				'clicked:page-contacts',
		'mainmenu.portfolio.clicked': 				'clicked:page-portfolio',
		'mainmenu.about.clicked': 					'clicked:page-about',
	...
	// SUB MENU CLICK EVENTS
		...
		'clicked:external-vkontakte': 				'clicked:external-vkontakte',
		'clicked:external-facebook': 				'clicked:external-facebook',
		'clicked:external-twitter': 				'clicked:external-twitter'
*/